 ...
 */
#include <dlfcn.h>
const char*  kPackageName = "org.sralab.emgimu.visualization";
...
class sensorgraph {
 ...
 public:
    ...
    void init(AAssetManager *assetManager) {
        AAsset *vertexShaderAsset = AAssetManager_open(assetManager, "graph_shader/shader.glslv",
                                                       AASSET_MODE_BUFFER);
        ...
        AAsset *fragmentShaderAsset = AAssetManager_open(assetManager, "graph_shader/shader.glslf",
                                                         AASSET_MODE_BUFFER);
...
JNIEXPORT void JNICALL
    Java_org_sralab_emgimu_visualization_GraphJNI_init(
    ...
    JNIEXPORT void JNICALL
    Java_org_sralab_emgimu_visualization_GraphJNI_surfaceCreated(JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
    ...
    JNIEXPORT void JNICALL
    Java_org_sralab_emgimu_visualization_GraphJNI_surfaceChanged(
    ...
    JNIEXPORT void JNICALL
    Java_org_sralab_emgimu_visualization_GraphJNI_drawFrame(
    ...
    JNIEXPORT void JNICALL
    Java_org_sralab_emgimu_visualization_GraphJNI_pause(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.pause();
    ...
    JNIEXPORT void JNICALL
    Java_org_sralab_emgimu_visualization_GraphJNI_resume(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.resume();
