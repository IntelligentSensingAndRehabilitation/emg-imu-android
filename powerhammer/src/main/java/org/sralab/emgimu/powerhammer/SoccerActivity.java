...
public class SoccerActivity extends UnityPlayerActivity
{
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mUnityPlayer.UnitySendMessage("SceneLoader", "loadScene", "4");
    }
    ...
    private final EmgImuServiceHolder.Callbacks mEmgImuCallbacks = new EmgImuServiceHolder.Callbacks() {
        ...
        public void onServiceBinded(EmgImuService.EmgImuBinder binder) {
            ...
            mGameLogger = new FirebaseGameLogger(binder, getString(R.string.title_activity_soccer), startTime);
            mService = binder;
        }
